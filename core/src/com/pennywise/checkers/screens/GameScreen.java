...
public class GameScreen extends AbstractScreen implements InputProcessor {
    ...
    private final com.pennywise.checkers.core.GameCam camera;
    ...
    private Group wordList() {
        ...
        float width = ((com.pennywise.checkers.core.Constants.GAME_WIDTH - cols) / (cols));
        ...
        for (int row = 0; row < rows; row++) {
            for (int col = 0; col < cols; col++) {
                ...
                tiles[index] = new com.pennywise.checkers.objects.Tile(word, new Label.LabelStyle(style));
    ...
    private void rewind() {
        ...
        for (com.pennywise.checkers.objects.Tile t : tileList) {
            t.getStyle().background = com.pennywise.checkers.core.Util.loadTexture("background/line_dark.png");
        }
    ...
    private void renderScore(SpriteBatch batch, float gameTime) {
        ...
        float x = com.pennywise.checkers.core.Constants.GAME_WIDTH * 0.45f;
        float y = com.pennywise.checkers.core.Constants.GAME_HEIGHT * 0.05f;
