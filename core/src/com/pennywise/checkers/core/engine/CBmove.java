...
//    public int oldpiece;        /* what disappears on from */
    ...
    public Point[] path = new Point[8]; /* intermediate path coordinates of the moving piece */
    public Point[] del = new Point[8]; /* squares whose pieces are deleted after the move */
    public int[] delpiece = new int[8];    /* what is on these squares */
}
