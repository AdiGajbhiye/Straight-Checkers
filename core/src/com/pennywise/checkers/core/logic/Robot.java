...
public class Robot {
     ...
     * 
     */
    private static int alphaBeta(com.pennywise.checkers.core.logic.Board board, Player player, int depth, int alpha, int beta, Vector<Move> resultMoveSeq){
        ...
        Vector<com.pennywise.checkers.core.logic.Board> possibleBoardConf = getPossibleBoardConf(board, possibleMoveSeq, player);
        ...
        if(player == Player.white){            
            ...
            for(int i=0; i<possibleBoardConf.size(); i++){
                ...
                com.pennywise.checkers.core.logic.Board b = possibleBoardConf.get(i);
    ...
    public static Vector<Vector<Move>> expandMoves(com.pennywise.checkers.core.logic.Board board, Player player){
    ...
    private static void expandMoveRecursivelyForWhite(com.pennywise.checkers.core.logic.Board board, Vector<Vector<Move>> outerVector, Vector<Move> innerVector, int r, int c){
