...
public class ConnectThread extends Thread {
	...
	public ConnectThread(BluetoothManager mBluetoothManager,
	...
	public void run() {
		...
		try {
			...
			try {
				Gdx.app.log(LOG,
						"Unable to connect. Will call close on mmSocket");
				mmSocket.close();
	...
	public void cancel() {
		try {
			Gdx.app.log(LOG,
					"Will cancel in-progress connection. Will call close on mmSocket");
			mmSocket.close();
		} catch (IOException e) {
